...
export class SHACLValidationService {
  ...
  public static async exportReportAsTurtle(
    ...
    const appRepository = appInfo?.repository || 'https://github.com/mjanez/metadata-quality-stack';
    const appUrl = appInfo?.url || 'https://mjanez.github.io/metadata-quality-stack/';
    const seeAlsoUrl = appInfo?.see_also || 'https://github.com/mjanez/metadata-quality-stack/blob/feature/main/react-app/README.md';
